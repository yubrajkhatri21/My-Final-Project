                ...
                <section class="table__body">
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM  ordertable od JOIN productdetails pd ON od.Product_id=pd.Product_id JOIN paymenttable pt ON pd.Product_id=pt.Product_id";
    ...
    <div class="main-body-delete" id="maindiv2">
        <div class="main-delete-container">
            <div class="inner-delete-container">
                <h2>Are You Want to confirm payment?</h2>
